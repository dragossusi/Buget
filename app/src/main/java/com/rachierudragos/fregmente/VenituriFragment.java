 ...
 */
public class VenituriFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        View rootView = inflater.inflate(R.layout.fragment_venituri,container,false);

        listView = (ListView)rootView.findViewById(R.id.listView_venituri);
        return rootView;
                        ...
                        .setPositiveButton("Schimbă", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                if(editText.getText().toString().equals(""))
                                    ...
                                    myDb.updatedetails(s, editText.getText().toString(), String.valueOf(spinner.getSelectedItem().toString().charAt(0)), 1);
